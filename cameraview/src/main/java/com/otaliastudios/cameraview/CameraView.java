...
public class CameraView
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!mCameraPreview.supportsCropping()) {
            ...
            if (widthMode == AT_MOST && lp.width == MATCH_PARENT) {
                widthMode = EXACTLY;
            }
            if (heightMode == AT_MOST && lp.height == MATCH_PARENT) {
                heightMode = EXACTLY;
            }
        }
     ...
     *
     * @param gesture
     *         which gesture to map
     * @param action
     *         which action should be assigned
     *
     ...
     *
     * @param owner
     *         the owner activity or fragment
     */
     ...
     *
     * @param sessionType
     *         the sessionType to be checked
     * @param audio
     *         the audio setting to be checked
     *
     ...
     *
     * @param whiteBalance
     *         desired white balance behavior.
     *
     ...
     *
     * @param x
     *         should be between 0 and getWidth()
     * @param y
     *         should be between 0 and getHeight()
     */
     ...
     *
     * @param file
     *         a file where the video will be saved
     */
    ...
    public void stopCapturingVideo() {
        ...
        mUiHandler.post(new Runnable() {
            @Override
            public void run() {
                if (getKeepScreenOn() != mKeepScreenOn) {
     ...
     *
     * @param videoMaxDurationMillis
     *         The maximum video duration in milliseconds
     */
    ...
    private class Callbacks
         ...
         *
         * @param consistentWithView
         *         is the final image (decoded respecting EXIF data) consistent with
         *         the view width and height? Or should we flip dimensions to have a
         *         consistent measure?
         * @param flipHorizontally
         *         whether this picture should be flipped horizontally after decoding,
